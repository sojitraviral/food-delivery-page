...
<html lang="en">
    <head>
            ...
            <meta name="description" content="Omnifood is a premium food delivery service with the mission to 
            bring affordable and healthy meals to as many people as possible">
            <link rel="stylesheet" type="text/css" media="screen" href="vendors/css/normalize.css" />
            <link rel="stylesheet" type="text/css" media="screen" href="vendors/css/grid.css" />
            <link rel="stylesheet" type="text/css" media="screen" href="vendors/css/ionicons.min.css" />
            <link rel="stylesheet" type="text/css" media="screen" href="vendors/css/animate.css" />
    ...
    <body>
        ...
        <section class="section-features js--section-features" id="features">
            ...
            <div class="row js--wp-1">
                <div class="col span-1-of-4 box">
                    <i class="icon-big ion-ios-infinite-outline"></i>
        ...
        <section class="section-testimonials">
            ...
            <div class="row">
                <div class="col span-1-of-3">
                     <blockquote>
                        Omnifood is just awesome!
                         I just launched a startup which leaves me with no time for cooking,
                          so Omnifood is a life-saver. 
                ...
                <div class="col span-1-of-3">
                   ...
                   <div class="col span-1-of-3">
                        <blockquote>
                                ...
                                in San Franciso. I tried a lot of them and ended up with Omnifood.
            ...
            <div class="row">
                ...
                <div class="col span-1-of-2">
                    <ul class="social-links">
                        <li>
                            <a href="#" class=""><i class="ion-social-facebook"></i></a>
                        </li>
                        <li>
                                <a href="#" class=""><i class="ion-social-twitter"></i></a>
                        </li>
                        <li>
                                <a href="#" class=""><i class="ion-social-googleplus"></i></a>
                        </li>
                        <li>
                                <a href="#" class=""><i class="ion-social-instagram"></i></a>
                        </li>
                    </ul>
        ...
        <script src="http://maps.google.com/maps/api/js?key=AIzaSyCC2zz7gtH8UP2oCxO18hNIQp3NIFz0HJE&callback=initMap"></script>
